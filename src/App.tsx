...
const ChatArea = ({ 
  ...
  setExplainInEnglish: (val: boolean) => void,
  ...
  const recognitionRefLocal = useRef<any>(null); // Kept for backward compatibility if needed, but we use the prop
  ...
  const startRecording = async (text: string) => {
    try {
      ...
      setPracticingWord(wordToPractice);
...
export default function App() {
  ...
  const [explainInEnglish, setExplainInEnglish] = useState(true);
  ...
  return (
    <div className="flex h-screen bg-black text-white overflow-hidden font-sans">
      ...
      <ChatArea 
        ...
        setExplainInEnglish={setExplainInEnglish}
